...
class ErrorHandler
{
	 ...
	 */
	public static function fatalLang(string $error, string|bool $log = 'general', array $sprintf = array(), int $status = 403)
	{
	 ...
	 * @param array $sprintf An array of data to be sprintf()'d into the specified message
	 */
	protected static function logOnline(string $error, array $sprintf = array())
	{
