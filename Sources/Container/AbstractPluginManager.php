...
use SMF\Container\Exception\ContainerModificationsNotAllowedException;
use SMF\Container\Exception\InvalidServiceException;
 ...
 */
abstract class AbstractPluginManager extends Container implements PluginManagerInterface
{
    /**
